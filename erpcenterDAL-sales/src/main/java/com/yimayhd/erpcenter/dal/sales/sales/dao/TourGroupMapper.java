...
public interface TourGroupMapper {
	...
	TourGroup findByGroupCode(@Param("code") String code);
	...
	List<TourGroup> selectSaleProfitByTourListPage(@Param("page") PageBean<TourGroup> pageBean, @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	
	List<TourGroup> selectSaleProfitByTourCon(@Param("page") PageBean<TourGroup> pageBean, @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	...
	TourGroup selectSaleProfitByTourConAndMode(@Param("page") PageBean<TourGroup> pageBean, @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	
	TourGroup selectSumCostProfit(@Param("tourGroup") TourGroup tourGroup, @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	...
	BigDecimal selectSaleProfitByModeAndTourId(@Param("id") Integer id, @Param("mode") Integer mode);
	...
	void updateWapType(@Param("id") Integer id);
	/**
	 * 查询初始团
	 * @param bizId
	 * @return
