...
public interface GroupOrderMapper {
	...
	List<GroupOrder> selectOrderByIdList(@Param("bizId") Integer bizId, @Param("idList") String strIdList);

	int updateByPrimaryKeySelective(GroupOrder record);

	int updateByPrimaryKey(GroupOrder record);

	List<GroupOrder> selectNotGroupListPage(@Param("page") PageBean pageBean, @Param("bizId") Integer bizId,
	                                        @Param("set") Set<Integer> set);

	GroupOrder selectTotalNotGroup(@Param("groupOrder") GroupOrder groupOrder, @Param("bizId") Integer bizId,
	                               @Param("set") Set<Integer> set);
	 ...
	 * @return
	 */
	List<GroupOrder> selectFitOrderListPage(@Param("page") PageBean pageBean, @Param("bizId") Integer bizId,
	                                        @Param("set") Set<Integer> set, @Param("listType") Integer listType);

	GroupOrder selectFitOrderTotalCount(@Param("groupOrder") GroupOrder groupOrder, @Param("bizId") Integer bizId,
	                                    @Param("set") Set<Integer> set, @Param("listType") Integer listType);
	 ...
	 * 订单日志-产品下订单明细
	 */
	List<GroupOrder> selectProductOrderListPage(@Param("page") PageBean pageBean, @Param("bizId") Integer bizId,
	                                            @Param("set") Set<Integer> set);

	GroupOrder selectGroupOrderCodeSort(@Param("bizId") Integer mode, @Param("startTime") String startTime);

	List<GroupOrder> selectByConListPage(@Param("page") PageBean<GroupOrder> pageBean, @Param("bizId") Integer bizId,
	                                     @Param("set") Set<Integer> set, @Param("listType") Integer listType);

	GroupOrder selectTotalByCon(@Param("groupOrder") GroupOrder groupOrder, @Param("bizId") Integer bizId,
	                            @Param("set") Set<Integer> set, @Param("listType") Integer listType);
	 ...
	 * app 计调
	 */
	List<GroupOrder> selectOrderByGroupIdAndBizId(@Param("groupId") Integer groupId, @Param("bizId") Integer bizId);

	Map<String, Integer> selectOrderByGroupIdAndName(@Param("groupId") Integer groupId, @Param("bizId") Integer bizId);
	 ...
	 * @return
	 */
	GroupOrder selectProfitByCon(@Param("page") PageBean<GroupOrder> pageBean, @Param("bizId") Integer bizId,
	                             @Param("set") Set<Integer> set);
	 ...
	 * @return
	 */
	GroupOrder selectProfitByConAndMode(@Param("page") PageBean<GroupOrder> pageBean, @Param("bizId") Integer bizId,
	                                    @Param("set") Set<Integer> set);
	 ...
	 * @return
	 */
	List<ProductGuestStaticsVo> productGuestStatics(@Param("condition") ProductGuestCondition condition,
	 ...
	 * @return
	 */
	List<Map<String, Object>> guestSourceStatics(@Param("condition") ProductGuestCondition condition,
	                                             @Param("set") Set<Integer> userIds);

	List<Map<String, Object>> guestSourceStatics2(@Param("parameter") Map parameter);

	List<Map<String, Object>> selectIncomeJoinTableListPage(@Param("page") PageBean<GroupOrder> pageBean,
	                                                        @Param("bizId") Integer bizId);
	...
	List<Map<String, Object>> getGroupInfoByGroupId(@Param("bizId") Integer bizId, @Param("groupId") Integer groupId);
	...
	List<SaleOperatorOrderStatic> selectSaleOperatorOrderStaticListPage(
			@Param("page") PageBean<SaleOperatorOrderStatic> pageBean, @Param("bizId") Integer bizId,
			@Param("set") Set<Integer> set);

	SaleOperatorOrderStatic selectSaleOperatorOrderStaticCon(@Param("page") PageBean<SaleOperatorOrderStatic> pageBean,
	                                                         @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	...
	GroupOrder selectTotalSpecialOrder(@Param("groupOrder") GroupOrder groupOrder, @Param("bizId") Integer bizId,
	                                   @Param("set") Set<Integer> set);
	...
	List<GroupOrder> selectOrderByParameterListPage(@Param("page") PageBean pageBean, @Param("bizId") Integer bizId,
	                                                @Param("set") Set<Integer> set);

	List<GroupOrder> selectOrderByParameter2(@Param("parameter") Map map);

	List<SaleOperatorVo> selectSaleOperatorByConListPage(@Param("page") PageBean<SaleOperatorVo> pageBean,
	                                                     @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);

	Map<String, Object> selectSaleOperatorTotalPerson(@Param("page") PageBean<SaleOperatorVo> pageBean,
	                                                  @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);

	String selectOrderLockByCon(@Param("page") PageBean<GroupOrder> pageBean, @Param("bizId") Integer bizId,
	                            @Param("set") Set<Integer> set);

	List<SalePrice> getSalePriceListPage(@Param("page") PageBean<SalePrice> pageBean, @Param("bizId") Integer bizId,
	                                     @Param("set") Set<Integer> set);

	BigDecimal getSalePriceToalPrice(@Param("page") PageBean<SalePrice> pageBean, @Param("bizId") Integer bizId,
	                                 @Param("set") Set<Integer> set);

	// 初始订单
	List<GroupOrder> selectInitOrderList(@Param("bizId") Integer bizId, @Param("groupId") Integer groupId);

	List<GroupOrder> selectOrderGroupByProductIdListPage(@Param("page") PageBean<GroupOrder> pageBean,
	                                                     @Param("bizId") Integer bizId, @Param("set") Set<Integer> set);
	 ...
	 * @return
	 */
	List<DepartmentOrderResult> departmentOrderStatistics(@Param("condition") DeparentmentOrderCondition condition,
	                                                      @Param("set") Set<Integer> set);

	List<GroupOrder> selectReserveOrderList();

	List<GroupOrder> selectAiYouOrders(@Param("bizId") Integer bizId, @Param("startTime") String startTime,
	 ...
	 * @return
	 */
	Map<String, Object> getCountByProductIdAndDate(@Param("bizId") Integer bizId, @Param("productId") Integer productId,
	                                               @Param("date") Date date);

	List<GroupOrder> selectTopAiYouOrders(@Param("bizId") Integer bizId, @Param("startTime") String startTime,
	 ...
	 * @return 销售订单情况
	 */
	List<GroupOrder> selectGroupOrderListToB2B(@Param("bizId") Integer bizId,@Param("dateStart") String dateStart, @Param("dateEnd") String dateEnd,
	 ...
	 * @return
	 */
	List<GroupOrder> selectProductTrendListPageInnerLayer(@Param("page") PageBean pageBean,@Param("parameter") Map map);
	List<GroupOrder> selectProductTrendListPageOutLayer(@Param("page") PageBean pageBean,@Param("parameter")Map parameters);
	
	List<GroupOrder> selectGroupOrderById(@Param("orderId") Integer orderId);
            
	List<GroupOrder> findResOrderListPage(@Param("page") PageBean pageBean,@Param("bizId") Integer bizId,@Param("set") Set<Integer> set);
	
	int updateResOrderState(GroupOrder record);
	
	HashMap<String, BigDecimal> sumGroupOrder(PageBean<GroupOrder> pageBean);
	
	List<GroupOrder> findResAdminOrderListPage(@Param("page") PageBean pageBean,@Param("bizId") Integer bizId,@Param("set") Set<Integer> set);
