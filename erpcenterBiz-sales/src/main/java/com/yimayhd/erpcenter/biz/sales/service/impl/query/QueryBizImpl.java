package com.yimayhd.erpcenter.biz.sales.service.impl.query;
...
//	}
	...
	public PageBean selectGroupBookingListPage(PageBean pageBean,
		...
		return queryDAL.selectGroupBookingListPage(pageBean, bizId, set);
//		List<GroupBookingInfo> bookingGroups =operationDal.selectGroupBookingListPage(pageBean, bizId, set);
//		if(bookingGroups!=null && bookingGroups.size()>0){
//			for(GroupBookingInfo bg : bookingGroups){
//				if(bg.getGroupMode().intValue()>0){
//					List<Map<String,Object>> orderMap= groupOrderDal.getOrderBreifInfoByGroupId(bg.getGroupId());
...
//
	...
	public PageBean<SaleOperatorVo> selectSaleOperatorByConListPage(
		...
		return queryDAL.selectSaleOperatorByConListPage(pageBean, bizId, set);
...
//	}
	...
	public PageBean selectProductGuestShopStatics(PageBean pageBean) {
		return queryDAL.selectProductGuestShopStatics(pageBean);
...
//	}
	...
	public Map<String, Object> getPersonCount(PageBean pageBean, Integer bizId, Set<Integer> set) {
		return queryDAL.getPersonCount(pageBean, bizId, set);
	}

	@Override
	public PageBean selectSupplierGuestShopStatics(PageBean pageBean,Set<Integer> set) {
		return queryDAL.selectSupplierGuestShopStatics(pageBean, set);
...
//		return pageBean;
	...
	public String getGuestSexInfo(Map parameters) {
		return queryDAL.getGuestSexInfo(parameters);
...
//				}
//			}
//			sb.append("['").append("男：").append("（"+maleAdultNum+"大"+maleChildNum+"小）',").append(maleNum).append("],")
//			.append("['").append("女：").append("（"+femaleAdultNum+"大"+femaleChildNum+"小）',").append(femaleNum).append("]");
//		}
//		return sb.toString();
	}
	...
	public String getGuestAgeInfo(Map parameters) {
		return queryDAL.getGuestAgeInfo(parameters);
...
//				}
//			}
//			sb. append("['").append("0~12岁：',").append(age1).append("],").
//				append("['").append("13~23岁：',").append(age2).append("],").
//				append("['").append("24~28岁：',").append(age3).append("],").
//				append("['").append("29~49岁：',").append(age4).append("],").
//				append("['").append("50~55岁：',").append(age5).append("],").
//				append("['").append("56~65岁：',").append(age6).append("],").
//				append("['").append("66岁以上：',").append(age7).append("]");
//		}
//		return sb.toString();
	}
	...
	public String getGuestAirTimeInfo(Map parameters) {
		return queryDAL.getGuestAirTimeInfo(parameters);
...
//		return sb.toString();
	...
	public String getGuestSouceInfo(Map parameters) {
		return queryDAL.getGuestSouceInfo(parameters);
//		List<Map<String,Object>> list = groupOrderDal.guestSourceStatics2(parameters);
//		if(list!=null && list.size()>0){
//			int len = list.size();
...
//		return "";
	...
	public Map<String, Object> getReceivePersonStatistics(Map parameters) {
		return queryDAL.getReceivePersonStatistics(parameters);
	}

	@Override
	public Map<String, Object> getPersonCountMap(Map parameters) {
		return queryDAL.getPersonCountMap(parameters);
	}

	@Override
	public Map<String, Object> selectSaleOperatorTotalPerson(
			PageBean<SaleOperatorVo> pageBean, Integer bizId, Set<Integer> set) {
		return queryDAL.selectSaleOperatorTotalPerson(pageBean, bizId, set);
	}

	@Override
	public Map<String, Object> selectDeliveryOriginalTotal(Map parameters) {
		return queryDAL.selectDeliveryOriginalTotal(parameters);
	}

	@Override
	public Map<String, Object> selectOriginalTotal1(Map parameters) {
		return queryDAL.selectOriginalTotal1(parameters);
	}

	@Override
	public Map<String, Object> selectOriginalTotal2(Map parameters) {
		return queryDAL.selectOriginalTotal2(parameters);
	}
	...
	public List<Map<String, Object>> selectBookingSupplierCountForGroups(String groupIds, Integer supplierType, String supplierName) {
		return queryDAL.selectBookingSupplierCountForGroups(groupIds, supplierType, supplierName);
	}
	
	@Override
	public List<Map<String, Object>> selectBookingShopCountForGroups(String groupIds, String supplierName) {
		return queryDAL.selectBookingShopCountForGroups(groupIds, supplierName);
	}
	
	@Override
	public List<Map<String, Object>> selectBookingGuideForGroups(String groupIds, String supplierName) {
		return queryDAL.selectBookingGuideForGroups(groupIds, supplierName);
	}
	
	@Override
	public List<Map<String, Object>> selectBookingDeliveryForGroups(String groupIds, String supplierName) {
		return queryDAL.selectBookingDeliveryForGroups(groupIds, supplierName);
	}
